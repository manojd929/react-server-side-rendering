...
// babel assumes regenerator runtime defined inside of working enviroment
// so polyfills is required
...
exports.default = [_extends({}, _App2.default, {
  routes: [_extends({
    ...
    path: '/admins'
  }, _AdminsListPage2.default), _extends({
    path: ''
...
var Header = function Header(_ref) {
  ...
  // using a tag here to change the content shown in entire browser
  ...
  _createClass(UsersList, [{
    ...
    value: function head() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement('meta', { property: 'og:type', content: 'Users App' })
      );
    }
  }, {
    key: 'render',
...
exports.default = function (req) {
  var axiosInstance = _axios2.default.create({
    ...
    headers: {
      cookie: req.get('cookie') || '' // to avoid having header as undefined
    }
  });
...
exports.default = function (ChildComponent) {
  ...
  return (0, _reactRedux.connect)(mapStateToProps)(RequireAuth); // make sure to return the component
};
